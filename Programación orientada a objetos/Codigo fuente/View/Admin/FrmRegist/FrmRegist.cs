...
namespace Project_POO
{
    public partial class FrmRegist : Form
    {
        ...
        private void btn_Create_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("La contraseña es muy corta, asegúrate de que sean mas de 5 caracteres",
            ...
            {
                MessageBox.Show("Las contraseñas no coinciden, asegúrate de que sean iguales",
            ...
            {
                MessageBox.Show("Nombre de usuario muy corto, asegúrate de que sean mas de 5 caracteres",
            ...
            if (!Regex.IsMatch(txt_Email.Text, emailExp))
            {
                MessageBox.Show(
                    "Correo electrónico  de usuario inválido, asegúrate de que contenga el formato `ejemplo@gmail.com`",
                    "Correo electrónico inválido", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
